    ...
    $.fn.tabs = function (options) {
        ...
        return this.each(function () {
            ...
            $(window).on('resize', function() {
                ...
                console.log(set.tabPaginationItems < tabPaginationClass.length)
                if ($(window).width() < 767) {
                    tabPaginationContainer.find(set.tabScrollClass).hide();
                ...
                tabContentWrapper.css({ marginLeft: tabPaginationClass.index(currentitem) * tabContent.outerWidth() * -1});
            });
